...
// (The C++ cudaLaunchKernelEx template errors "undefined" on the CUDA 11.8 Windows
//  toolchain; it builds clean on 12.x. Upstream only CI-tests CUDA 12.x. QVAC-19386.)
