...
bool near_eq(double actual, double expected, double tolerance) {
...
void test_lyrics_preprocessing() {
    ...
    CHECK(near_eq(scoring.average_matrix(0, 0), 2.0, 1e-6));
    CHECK(near_eq(scoring.energy_matrix(0, 0), 0.0, 1e-6));
    CHECK(near_eq(scoring.energy_matrix(1, 2), 1.0, 1e-6));
    CHECK(near_eq(scoring.calc_matrix(0, 1), 0.04, 1e-6));
...
void test_lyrics_metrics_and_score() {
    ...
    CHECK(near_eq(metrics.coverage, 1.0, 1e-12));
    CHECK(near_eq(metrics.monotonicity, 1.0, 1e-12));
    CHECK(near_eq(metrics.path_confidence, 0.74, 1e-7));
    CHECK(near_eq(calculate_lyrics_score(metrics), 0.74, 1e-12));
}
...
void test_lyrics_timestamps_and_lrc() {
    ...
    CHECK(near_eq(aligned[0].start, 0.0, 1e-12));
    CHECK(near_eq(aligned[0].end, 1.0, 1e-12));
    CHECK(near_eq(aligned[1].start, 1.0, 1e-12));
    CHECK(near_eq(aligned[1].end, 3.0, 1e-12));
    ...
    CHECK(near_eq(sentences[0].start, 1.235, 1e-12));
    CHECK(near_eq(sentences[0].confidence, 0.0, 1e-12));
    CHECK(near_eq(sentences[1].confidence, 1.0, 1e-12));
